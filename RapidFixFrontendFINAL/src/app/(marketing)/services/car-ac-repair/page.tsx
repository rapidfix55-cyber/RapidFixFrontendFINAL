...
export const metadata: Metadata = {
  title: "Car AC Repair | Doorstep Service | RapidFix",
  description: "Book expert car ac repair with RapidFix. We provide the best car repair near me, bike repair near me, and automotive repair in Delhi NCR.",
  ...
  alternates: { canonical: "https://www.rapidfixauto.in/services/car-ac-repair" },
};
